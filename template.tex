...
\newcommand{\tabularframeheadrepeatlast}[1]{
	...
	\global\def\jjjjjj{\expandafter\csname}
	\global\def\kkkkkk{\expandafter\endcsname}
...
\def\corereplacestring#1#2#3{%
	\def\tmp##1#2{##1#3\tmp}%
	\tmp#1\corestopreplacestring#2\corestopreplacestring}
\def\corestopreplacestring#1\corestopreplacestring{}
\usepackage{xstring}

\newcommand{\addtfheadcolumnf}[2]{%
	\expandafter\stepcounter{tabularcolnumber}%
	\expandafter\column{\expandafter\dimexpr#1\expandafter\linewidth}
}
\newwrite\tempfile
...
\newcommand{\addtfheadcolumn}[2]{%
	...
	\ifthenelse{\equal{\GLOBALtabularframestorevar}{true}}{%
		\immediate\write\tempfile{\unexpanded{\addtfheadcolumn{#1}{#2}}\percentchar}%
	}{}%
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={1.1.5-2-PRES},
		Template.Version.Hash={1083DCB83948A9065F0E6EB73075A5EE},
	...
	pdfproducer={Template-Presentacion v1.1.5 | (Pablo Pizarro R.) ppizarror.com},
