...
\begin{frame}
	\begin{tabularframehead}{1}
		\addtfheadcolumn{0.2}{Primer titular}%
		\addtfheadcolumn{0.2}{Segundo titular}%
		\addtfheadcolumn{0.2}{Tercer titular}%
		\addtfheadcolumn{0.3}{Tercer \textbf{titular}}%
		\addtfheadcolumn{0.4}{Tercer titular}%
	\end{tabularframehead}
	\tabularframecontent{
		\begin{itemize}[leftmargin=*]
			\item A
