...
\def\documentinterline {1}         % Interlineado del documento defecto [factor]
...
\def\frametextjustified {false}    % Justifica todos los párrafos de los frames
...
\def\captionlrmarginmc {0}         % Mar. izq/der leyenda dentro de columnas [cm]
...
\def\bibtexstyle {apalike}         % Formato de ref. bibtex {apa,ieeetr,etc...}
